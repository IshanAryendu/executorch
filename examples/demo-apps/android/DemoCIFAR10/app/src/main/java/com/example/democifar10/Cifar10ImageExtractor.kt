...
class Cifar10ImageExtractor {
    companion object {
         ...
         */
        @JvmStatic
        fun extractAndSaveImages(context: Context, inputStream: FileInputStream, numImages: Int): Array<String?> {
                ...
                for (i in 0 until numImages) {
                    ...
                    for (y in 0 until IMAGE_HEIGHT) {
                        for (x in 0 until IMAGE_WIDTH) {
                            ...
                            val g = buffer[LABEL_SIZE + IMAGE_WIDTH * IMAGE_HEIGHT + y * IMAGE_WIDTH + x].toInt() and 0xFF
                            val b = buffer[LABEL_SIZE + 2 * IMAGE_WIDTH * IMAGE_HEIGHT + y * IMAGE_WIDTH + x].toInt() and 0xFF
